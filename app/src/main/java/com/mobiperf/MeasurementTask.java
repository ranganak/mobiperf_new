...
public abstract class MeasurementTask implements Callable<MeasurementResult>, Comparable {
  ...
  static {    
    ...
    measurementUIVisibility.put(DnsLookupTask.DESCRIPTOR, false);
    ...
    measurementUIVisibility.put(TCPThroughputTask.DESCRIPTOR, false);
    ...
    measurementUIVisibility.put(UDPBurstTask.DESCRIPTOR, false);
  }

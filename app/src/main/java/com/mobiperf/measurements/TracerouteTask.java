...
public class TracerouteTask extends MeasurementTask {
  ...
  public static class TracerouteDesc extends MeasurementDesc {
    ...
    protected void initializeParams(Map<String, String> params) {
      ...
      try {        
        ...
        throw new InvalidParameterException("TraceRouteTask cannot be created due to invalid params");
      }
    }
  ...
  private String getHostIp(String line) {      
    ...
    String tempIp = tokens[1].replaceAll(":","");
    if (isValidIpv4Addr(tempIp) || isValidIpv6Addr(tempIp)) {
      ...
      for (int i = 0; i < tokens.length; i++) {
        if (i == 1) {
          ...
          if (isValidIpv4Addr(tokens[i].replaceAll(":","")) || isValidIpv6Addr(tokens[i].replaceAll(":",""))) {

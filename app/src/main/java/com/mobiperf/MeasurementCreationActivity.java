...
public class MeasurementCreationActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    spinnerValues = new ArrayAdapter<String>(this.getApplicationContext(), R.layout.my_spinner_layout);
    ...
    spinnerValues.setDropDownViewResource(R.layout.my_spinner_dropdown_item_layout);

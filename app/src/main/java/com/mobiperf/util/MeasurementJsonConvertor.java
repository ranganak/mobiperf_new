...
public class MeasurementJsonConvertor {
  ...
  public static void initializePrams(MeasurementDesc desc, JSONObject json) throws JSONException
  {
    Map<String, String> params = new HashMap<String, String>();
    params.put("target", String.valueOf(json.getString("target")));
  ...
  public static MeasurementTask makeMeasurementTaskFromJson(JSONObject json, Context context) 
    ...
    try {
      ...
      initializePrams(measurementDesc,json);

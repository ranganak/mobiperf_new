...
public class Checkin {
  ...
  public void uploadMeasurementResult(JSONArray resultArray, ResourceCapManager resourceCapManager)
    ...
    try {
      ...
      for (int i = 0; i < resultArray.length(); i++) {
        ...
        tempJsonArray.put(0, jsonObject);

        serviceRequestNew("http://bingperf.azurewebsites.net/home/StoreResults", tempJsonArray.toString());
  ...
  private String serviceRequestNew(String url, String jsonString)
          throws IOException {

    HttpClient client = getNewHttpClient();
    Logger.i("Checking in to " + url);
